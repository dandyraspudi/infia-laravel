		...
		columnDefs: [
			{
				...
				render: function (data, type, full, meta) {
					...
					template =`
						<a role="button" class="btn btn-primary btn-xs" title="Edit" href="`+ data.url_edit +`">
			...
			},
			{
				...
				render: function (data, type, full, meta) {
					...
					let status = (full.status) ? 'checked' : '';
					template =`
						<input type="checkbox" `+ status +` id="publish`+full.news_id+`" data-id="`+ full.news_id +`" data-url="`+ full.url_publish +`" style="cursor: pointer;" onclick="showSwal('updatePublish', this)">
					`;
